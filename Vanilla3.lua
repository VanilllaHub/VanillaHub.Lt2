...
-- Toggle switch (matches VanillaHub LT2 style)
...
getgenv().treestop = getgenv().treestop or true
        ...
        task.spawn(function()
            ...
            task.spawn(function()
                repeat task.wait()
                    ...
                    local fp = childbranch.Parent:FindFirstChild("WoodSection")
                    if fp then player.Character.HumanoidRootPart.CFrame = fp.CFrame * CFrame.new(5,0,0) end
                until worked
            end)
